...
vi.mock('lucide-react', () => ({
  ...
  Ticket: () => <div data-testid="icon-mock" />,
  Star: () => <div data-testid="icon-mock" />,
  MessageSquare: () => <div data-testid="icon-mock" />,
}));

// 'Sidebar'ı 'MemoryRouter' VE 'AppProvider' ile sarmalayan yardımcı render fonksiyonu
